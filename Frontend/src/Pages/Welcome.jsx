...
const Welcome = () => {
  ...
  useEffect(() => {
    const StartServer = async () => {
      const res = await axiosInstance.get("/users/server");
      if (res.status === 200) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            >
              <div className="p-4 sm:p-6">
                ...
                >
                  Creator of EndVerse AI with expertise in React, Node.js, and
                  machine learning. Passionate about building innovative AI
                  solutions.
                </p>
